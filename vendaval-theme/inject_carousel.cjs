...
html = html.replace('<div class="css-mrzb66 css-skrg0u css-7ccwbh"><div class="css-5knerd css-v27th6" style="opacity:1;transform:none"></div></div>', `<div class="css-mrzb66 css-skrg0u css-7ccwbh">${carouselHTML}</div>`);

fs.writeFileSync(pageHomePath, html);
console.log('Carousel injected into page-home.php');
