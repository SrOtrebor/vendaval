<?php
/*
Template Name: Curso - Introducción
*/
get_header(); ?>
    ...
    <div class="container" style="padding-top: var(--spacing-xl);">
        ...
        <div class="curso-top">
            <div class="curso-image">
                <img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/figma_assets/5b99b820592c1a2eceb08a83cb6898964e9b2804.png" alt="Introducción a la serigrafía">
            </div>
            <div class="curso-buy">
